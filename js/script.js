...
function gameEngine() {
  ...
  snakeArr[0].y += inputDir.y; // Part 2: Display the snake and Food // Display the snake
...
let bottombtn = document.getElementById("bottom"); // x: 0, // y: 1
...
leftbtn.addEventListener("click", () => {
  ...
  musicSound.play();
  inputDir.x = -1;
  inputDir.y = 0; // snakeElement.style.transform = "rotate(60deg)";
});
